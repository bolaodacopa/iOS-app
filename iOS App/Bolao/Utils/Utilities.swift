...
class Utilities {
  ...
  func scoreTextFiled() -> UITextField {
    let tf = UITextField()
    tf.placeholder = "0"
    tf.textColor = .white
    tf.font = UIFont.systemFont(ofSize: 70)
  ...
  func attributedButton(_ firstPart: String, _ secondPart: String ) -> UIButton {
    ...
    attributtedTitle.append(NSAttributedString(string: secondPart, attributes: [NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 16), NSAttributedString.Key.foregroundColor: UIColor.white]))
